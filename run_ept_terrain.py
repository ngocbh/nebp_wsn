...
def run_ept():
    ...
    input_dir = './data/test' if TESTING else './data/ept_terrain'
    output_dir = None
    testset = 0 if TESTING else 8
    ...
    run.run_mhn_experiment(ept, input_dir, output_dir, testset, testnames, k, overwrite=RERUN, config=config, brief_name='s5', combined=True)
