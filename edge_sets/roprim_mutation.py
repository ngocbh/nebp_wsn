...
class ROPrimMutation(Mutation):

    def __init__(self, pm, max_hop=None):
        self.max_hop = max_hop
        super(ROPrimMutation, self).__init__(pm=pm)
    ...
    def mutate(self, indv: Individual, random_state=None):
        ...
        tree.build_relay_oriented_prim_tree(max_energy, used_relays_mask, edges, random_state, max_hop=self.max_hop)
