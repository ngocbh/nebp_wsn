...
def solve(filename, output_dir=None, model='0.0.4.0', config=None, save_history=True, seed=None, save=True):
    ...
    if save:
        ...
        P = [[0, 0],[0, 0]]
        P[0][0], P[0][1] = 0, energy_consumption(problem._num_of_sensors, 1, problem._radius * 2)
...
if __name__ == '__main__':
    ...
    solve('data/_tiny/multi_hop/tiny_ga-dem1_r25_1_40.json', model = '1.7.4.0', config=config)
    # solve('data/_medium/multi_hop/medium_ga-dem1_r25_1_40.json', model='1.8.4.0', config=config)
